import { pgTable, unique, text, boolean, timestamp, integer, numeric, foreignKey, index, uuid } from "drizzle-orm/pg-core"
...
export const productSales = pgTable("product_sales", {
	...
	index("product_sales_created_at_idx").using("btree", table.createdAt.asc().nullsLast().op("timestamp_ops")),
	index("product_sales_product_id_idx").using("btree", table.productId.asc().nullsLast().op("uuid_ops")),
	index("product_sales_seller_id_idx").using("btree", table.sellerId.asc().nullsLast().op("text_ops")),
	foreignKey({
...
export const dailyAnalytics = pgTable("daily_analytics", {
	...
	index("daily_analytics_date_idx").using("btree", table.date.asc().nullsLast().op("timestamp_ops")),
	index("daily_analytics_product_id_idx").using("btree", table.productId.asc().nullsLast().op("uuid_ops")),
	foreignKey({
			columns: [table.productId],
			foreignColumns: [products.id],
...
export const productViews = pgTable("product_views", {
	...
	index("product_views_created_at_idx").using("btree", table.createdAt.asc().nullsLast().op("timestamp_ops")),
...
export const productLikes = pgTable("product_likes", {
	...
	index("product_likes_product_id_idx").using("btree", table.productId.asc().nullsLast().op("uuid_ops")),
	foreignKey({
			columns: [table.productId],
			foreignColumns: [products.id],
